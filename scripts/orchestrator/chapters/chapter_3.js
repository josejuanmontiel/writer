  ...
  scenes: [
    {
      ...
      action: async (page, durationMs, mcp) => {
        await page.mouse.move(150, 200, { steps: 15 });
    ...
    },
    {
      ...
      action: async (page, durationMs, mcp) => {
        // Clic en pestaña Grafo 2.0 para ver la extracción
        const grafoTab = await page.$('button:has-text("Grafo 2.0"), button:has-text("Grafo")');
        if (grafoTab) {
          await grafoTab.click({ force: true });
      ...
      action: async (page, durationMs, mcp) => {
        ...
        try {
          ...
          if (editorEl) {
            ...
            await page.keyboard.type("\n\n== Prerrequisitos de Vuelo\nEl conocimiento de propulsión iónica es indispensable.", { delay: 20 });
          }
        } catch (e) {}
      }
    },
    {
      ...
      action: async (page, durationMs, mcp) => {
        await page.mouse.move(180, 450, { steps: 15 });
      }
    }
  ]
};
